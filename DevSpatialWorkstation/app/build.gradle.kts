...
android {
  namespace = "com.meta.spatial.samples.devworkstation"
  //noinspection GradleDependency
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.devworkstation"
    minSdk = 34
...
spatial {
  ...
  scenes {
    ...
    hotReload {
      appPackage.set("com.meta.spatial.samples.devworkstation")
      appMainActivity.set(".WorkstationActivity")
